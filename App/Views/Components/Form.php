...
*/
	...
	{
		return ($name != 'email') ? $this->surround('<input type="text" name="'.$name .'"class="validate" placeholder="Enter your ' .$name.'">') 
		:  $this->surround('<input type="text" name="'.$name .'"class="validate">');
...
*/
	...
	{
		return $this->surround('<input type="password" name="'.$name .'" class="validate">');	
	}
/**
...
*/
	...
	{
		return  $this->surround('<button class="orange btn waves-effect waves-light center right">
